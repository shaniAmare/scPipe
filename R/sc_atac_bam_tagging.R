...
sc_atac_bam_tagging <- function(inbam, output_folder = "scPipe-atac-output",
                                bc_length = NULL,
  ...
  # If output_folder is NULL, just output the BAM into the same directory as inbam 
  if (is.null(output_folder)) {
    # output_folder <- paste0(sub('[/][^/]+$', '', inbam)) 
    # The below is the most efficient way!
    output_folder = dirname(inbam)
  }
